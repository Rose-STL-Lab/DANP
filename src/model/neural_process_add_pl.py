    ...
    def forward(self, inputs, start_seq, labels=None):
        ...
        if self.l0:
            if labels is not None:
                ...
                seq_encoding = self.l0(start_seq[..., :7])
...
class Decoder(torch.nn.Module):
    ...
    def __init__(
        self, in_dim, out_dim, seq_model=None, init_func=torch.nn.init.normal_, l1_size =8, l2_size=8, l3_size=8
    ):
        ...
        self.l1_size = l1_size  # 16
        self.l2_size = l2_size  # 16
...
class DCRNNModel(nn.Module):
    def __init__(
        ...
        self.decoder = Decoder(
            x_dim + z_dim + seq_enc_hidden_size, y_dim, seq_model=seq_model
        )  # (x*, z) -> y*
        self.z_mu_all = 0
        self.z_logvar_all = 0
        self.z_mu_context = 0
    ...
    def make_posterior(self, x_t, start_seq, zs, seq_steps, labels=None):
        ...
        if self.seq_model:
            ...
            xz = torch.cat([pl, x_t, zs_reshaped], dim=2)
